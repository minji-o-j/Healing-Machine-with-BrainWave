...
namespace test5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public static int first_bad = 0;
        public static int first_good = 0;
        ...
        public static int count_choice2 = 0;
        #endregion
        ...
        {
            timer_c = new System.Windows.Forms.Timer() { Interval = (second2 + 1) * 1000 };
            if (chec == 0)
            {
                second2 += 8;
                chec++;
        ...
        public static void choice(object sender, System.EventArgs e)
        {
            ...
            while (FTData2.Count < second2)
            {
                ...
                if (fi.Exists)
                {
                    ...
                    //변화량구하기
                    if ((FTData2.Count < 8) && (first_good < 8))
                    {
                        first_good++;
                    ...
                    else if ((FTData2.Count < 8) && (first_good >= 8))
                    {
                        first_good++;
                        FTData2.Add(OneSecFFT2);
                        double data1 = (double)FTData1[count3];
            ...
            if (count_choice == 0)
            {
                ...
                else if (udata0 <= ct)
                {
                    ...
                    count3 = 0;
                    while (timeDiff < TimeSpan.FromSeconds(29))
                    {
                        string path = @"C:\Users\정민지\Desktop\DB\" + count2 + ".txt";
                        FileInfo fi = new FileInfo(path);
                        string RData2 = "0.1";
        ...
        {
            timer_c2 = new System.Windows.Forms.Timer() { Interval = (second3 + 1) * 1000 };
            if (chec3 == 0)
            {
                second3 += 8;
                chec3++;
        ...
        public static void choice2(object sender, System.EventArgs e)
        {
            if (count_bad == 0)
            {
                SetCursorPos(797, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0); //체험종료
            ...
            while (FTData2.Count < second3)
            {
                ...
                if (fi.Exists == true)
                {
                    ...
                    if ((FTData2.Count < 8) && (first_bad < 8))
                    {
                        first_bad++;
                        FTData2.Add(OneSecFFT2);
                        double data1 = (double)FTData1[count3];
                    ...
                    else if ((FTData2.Count < 8) && (first_bad >= 8))
                    {
                        first_bad++;
                        FTData2.Add(OneSecFFT2);
                        double data1 = (double)FTData1[count3];
            ...
            else if (count_choice2 != 0)
            {
                for (int i = count_choice2; ; i++)
                {
                    ...
                    else if ((udata1 <= ct) && (udata2 <= ct))
                    {
                        ...
                        TimeSpan timeDiff = currentTime - startTime;
                        count3 = 0;
                        while (timeDiff < TimeSpan.FromSeconds(30))
                        {
                            string path = @"C:\Users\정민지\Desktop\DB\" + count2 + ".txt";
                            FileInfo fi = new FileInfo(path);
                            string RData2 = "0.1";
        ...
        public static void Sound(int ran)
        {
            if (ran == 1)
            {
                SetCursorPos(525, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
                mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            }
            else if (ran == 2)
            {
                SetCursorPos(630, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
                mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            }
            else if (ran == 3)
            {
                SetCursorPos(716, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
                mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            }
        }
        ...
        public static void Image2(int ran)
        {
            if (ran == 1)
            {
                SetCursorPos(894, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
                mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            }
            else if (ran == 2)
            {
                SetCursorPos(986, 170);
                mouse_event(MOUSEEVENTF_LEFTDOWN, 0, 0, 0, 0);
                mouse_event(MOUSEEVENTF_LEFTUP, 0, 0, 0, 0);
            }
        }
